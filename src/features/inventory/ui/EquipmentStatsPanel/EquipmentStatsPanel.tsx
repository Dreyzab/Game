    ...
    <div className="glass-panel space-y-4 p-4">
      ...
      <div className="grid grid-cols-3 gap-3 text-center">
        <div className="rounded-lg border border-slate-700/80 px-3 py-2">
          ...
          <div className="text-lg font-semibold text-[color:var(--color-text-primary)]">{stats.totalDamage}</div>
        </div>
        <div className="rounded-lg border border-slate-700/80 px-3 py-2">
          <div className="text-[10px] uppercase tracking-[0.3em] text-slate-500">Defense</div>
          <div className="text-lg font-semibold text-[color:var(--color-text-primary)]">{stats.totalDefense}</div>
        </div>
        <div className="rounded-lg border border-slate-700/80 px-3 py-2">
          <div className="text-[10px] uppercase tracking-[0.3ем] text-slate-500">Weight</div>
          <div className="text-lg font-semibold text-[color:var(--color-text-primary)]">{stats.totalWeight} kg</div>
        </div>
      </div>
          ...
          <div className="space-y-3">
            {masteryCards.map((entry) => (
              <div key={entry.itemId} className="rounded-lg border border-slate-700/80 p-3">
                <div className="text-sm font-semibold text-[color:var(--color-text-primary)]">{entry.itemName}</div>
