...
export const schwabentorGateScenes: Record<string, Scene> = {
  schwabentor_morning_denial: {
    ...
    dialogue: [
      {
        speaker: 'Рассказчик',
        text: 'Ворота Швабентор — массивная арка, перекрытая баррикадами. Туман с горы стелется низко, словно хочет заползти в город. Усиленный патруль FJR проверяет документы у редких желающих выйти наружу.',
      },
      {
        speaker: 'Рассказчик',
        text: 'Ты подходишь к шлагбауму и протягиваешь записку Дитера. Шмидт читает её, и лицо у него мрачнеет.',
      },
      {
