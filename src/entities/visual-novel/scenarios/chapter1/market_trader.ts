...
export const marketTraderScenes: Record<string, Scene> = {
  ...
  trader_meeting_dialog: {
    ...
    dialogue: [
      {
        speaker: 'Рассказчик',
        text: 'Ты оставляешь вокзал позади. Город встречает тебя шумом и запахами. Площадь Старой Синагоги — это муравейник. Сотни людей, палатки из брезента, запах жареного мяса и специй.',
      },
      {
        speaker: 'Рассказчик',
      ...
      },
      {
        speaker: 'Элиас',
        characterId: 'elias',
        text: '— Чего надо? — бурчит он, не поднимая головы от какого-то механизма, который он чистит.',
    ...
    choices: [
      ...
      {
        id: 'dog_trade_joke',
        text: '[ТОРГОВЛЯ] "Хороший пёс. Сколько стоит?" (Попытаться наладить контакт шуткой).',
  ...
  elias_delivery_pickup: {
    ...
    dialogue: [
      {
        speaker: 'Вы',
        text: '— Я от Ганса, — говоришь ты прямо. — Пришёл за запчастями для Дитера.',
      },
      {
        speaker: 'Рассказчик',
        text: 'Старик замирает. Медленно поднимает голову. Его взгляд оценивающий, колючий.',
      },
      {
        speaker: 'Элиас',
        characterId: 'elias',
        text: '— От Ганса? — переспрашивает он. — Значит, курьер. Ну-ну.',
        emotion: { primary: 'neutral', intensity: 65 },
      },
      {
        speaker: 'Рассказчик',
        text: 'Он наклоняется под прилавок и с кряхтением вытаскивает тяжёлый, промасленный деревянный ящик. Ставит его перед тобой с глухим стуком.',
      },
      {
        speaker: 'Элиас',
        characterId: 'elias',
        text: '— Вот. Конденсаторы, предохранители, пара сервоприводов. Всё как заказывали. — Он прищуривается. — Только смотри, не разбей. Дитер шкуру спустит, если хоть одна лампа треснет. И со мной, и с тебя.',
        emotion: { primary: 'neutral', intensity: 60 },
      },
      {
        speaker: 'Рассказчик',
        text: 'Ты берёшь ящик. Тяжёлый. Килограммов десять, не меньше.',
      },
      {
        speaker: 'Элиас',
        characterId: 'elias',
        text: '— И ещё, — Элиас понижает голос. — Передай Дитеру, что Фленс недоволен задержкой оплаты. Пусть не тянет с кредитами. Понял?',
