    ...
    dialogue: [
      {
        speaker: 'Старуха-регистратор',
        characterId: 'old_registrar',
        text: 'Готово. Теперь ты в реестре. Слушай внимательно: во Фрайбурге выживают не самые сильные, а самые аккуратные.',
      },
      {
        speaker: 'Старуха-регистратор',
        characterId: 'old_registrar',
        text: 'Промзона — Артисаны. Мастерские, ремонт, тяжёлая работа. Если умеешь чинить — там найдёшь место.',
      },
      {
        speaker: 'Старуха-регистратор',
        characterId: 'old_registrar',
        text: 'Кампус — «Синтез». Наука, лаборатории, контракты. Туда идут головой, не кулаками.',
      },
      {
        speaker: 'Старуха-регистратор',
        characterId: 'old_registrar',
        text: 'Кафедраль — отец Иоанн. У них еда и крыша, но за всё платят правилами.',
      },
      {
        speaker: 'Старуха-регистратор',
        characterId: 'old_registrar',
        text: 'Августинская площадь — анархисты. Не трогай их первым — и они, возможно, не тронут тебя. Возможно.',
      },
      {
        speaker: 'Рассказчик',
        text: 'Она делает паузу и оценивающе прищуривается.',
      },
      {
        speaker: 'Старуха-регистратор',
        characterId: 'old_registrar',
        text: 'И последнее: FJR. Патруль и порядок. Если попадёшь под их защиту — будет легче. Если под их подозрение — наоборот.',
