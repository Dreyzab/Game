 ...
 * FSD: shared/types
 */
export type MapPointType = 'poi' | 'quest' | 'npc' | 'location' | 'board' | 'settlement' | 'anomaly' | 'shop';
...
export type FactionType = 'fjr' | 'ordnung' | 'artisans' | 'synthesis' | 'anarchists' | 'merchants' | 'traders' | 'old_believers' | 'farmers' | 'neutral' | 'unknown' | 'contested' | 'government';
